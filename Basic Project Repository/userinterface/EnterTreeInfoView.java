    ...
    private VBox createFormContents()
    {
        ...
        submitButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                // do the deposit
                processAction(e);
                myModel.stateChangeRequest("AddTreeInfo", int_prop);
            }
        });
...
//        }
    ...
    {
        int_prop = new Properties();
        int_prop.setProperty("Barcode", barcode_text);
        int_prop.setProperty("TreeType", treeType_text);
        int_prop.setProperty("Notes", notes_text);
        int_prop.setProperty("Status", status_text);
    }
